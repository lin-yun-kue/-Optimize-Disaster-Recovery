...
DEFAULT_DISASTER_OPERATIONAL_PRIORS: dict[str, dict[str, Any]] = {
    "landslide": {
        ...
        # Tier C placeholder: kept short until event-level CAD data exists.
        "dispatch_delay_minutes_range": (5.0, 30.0),
    ...
    "snow": {
        ...
        "dispatch_delay_minutes_range": (0.0, 15.0),
    ...
    "flood": {
        ...
        "dispatch_delay_minutes_range": (10.0, 45.0),
