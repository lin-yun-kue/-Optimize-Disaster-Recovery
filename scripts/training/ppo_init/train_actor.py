...
class PPOConfig:
    ...
    save_dir: str = "experiment_results/ppo_init_actor"
    critic_checkpoint: str = "experiment/ppo_custom"
...
def resolve_critic_checkpoint(path_str: str) -> Path:
...
def train(config: PPOConfig) -> Path:
    ...
    env = make_env(config, controller_name="ppo_actor_init")
    ...
    print(f"Saved actor-init PPO artifacts to {run_dir}")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--critic-checkpoint",
        type=str,
        default=PPOConfig.critic_checkpoint,
